...
app.get('/api/status', async (req, res) => {
  ...
  const platformStatus = db.ok && metrics.errorRate < 5 ? 'operational' : 'degraded'
  ...
  res.json({
    ...
    data: {
      ...
      aiServices: [
        { name: 'OpenAI GPT', status: providers.openai ? 'operational' : 'not-configured', responseTime: 300, uptime: providers.openai ? 99.9 : 0 },
        { name: 'Claude (Anthropic)', status: providers.anthropic ? 'operational' : 'not-configured', responseTime: 350, uptime: providers.anthropic ? 99.9 : 0 },
        { name: 'Google Gemini', status: providers.gemini ? 'operational' : 'not-configured', responseTime: 320, uptime: providers.gemini ? 99.9 : 0 },
        { name: 'Mistral AI', status: providers.mistral ? 'operational' : 'not-configured', responseTime: 330, uptime: providers.mistral ? 99.9 : 0 },
        { name: 'Cohere', status: providers.cohere ? 'operational' : 'not-configured', responseTime: 340, uptime: providers.cohere ? 99.9 : 0 }
      ]
    }
  })
})
