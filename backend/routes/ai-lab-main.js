...
router.get('/stats', async (req, res) => {
  try {
    ...
    const DatasetAnalysis = (await import('../models/DatasetAnalysis.js'))
      .default;
    const ImageGeneration = (await import('../models/ImageGeneration.js'))
      .default;
    const EmotionAnalysis = (await import('../models/EmotionAnalysis.js'))
      .default;
    const FuturePrediction = (await import('../models/FuturePrediction.js'))
      .default;
    const MusicGeneration = (await import('../models/MusicGeneration.js'))
      .default;
    const PersonalityTest = (await import('../models/PersonalityTest.js'))
      .default;
    const CreativeWriting = (await import('../models/CreativeWriting.js'))
      .default;
    const SmartAssistant = (await import('../models/SmartAssistant.js'))
      .default;
    const VirtualReality = (await import('../models/VirtualReality.js'))
      .default;
    const LanguageLearning = (await import('../models/LanguageLearning.js'))
      .default;
...
export const setupAILabRoutes = (app) => {
  ...
  console.log(
    '   🔮 Future Prediction: GET|POST /api/ai-lab/future-prediction'
  );
  ...
  console.log(
    '   ✍️  Creative Writing: GET|POST|PUT /api/ai-lab/creative-writing'
  );
  ...
  console.log(
    '   🌍 Language Learning: GET|POST|PUT /api/ai-lab/language-learning'
  );
};
