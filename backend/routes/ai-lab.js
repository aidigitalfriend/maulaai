...
const upload = multer({
  ...
  fileFilter: (req, file, cb) => {
    ...
    const allowedTypes =
      /jpeg|jpg|png|gif|wav|mp3|mp4|avi|csv|json|txt|pdf|doc|docx/;
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res.json(
        createResponse(true, experiments, 'Experiments retrieved successfully')
      );
    } catch (error) {
      console.error('Error fetching experiments:', error);
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch experiments'));
    }
  })
);
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(201)
        .json(
          createResponse(true, experiment, 'Experiment created successfully')
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    if (!validateObjectId(id)) {
      return res
        .status(400)
        .json(createResponse(false, null, 'Invalid experiment ID'));
    }
    ...
    try {
      ...
      if (!experiment) {
        return res
          .status(404)
          .json(createResponse(false, null, 'Experiment not found'));
      }

      res.json(
        createResponse(true, experiment, 'Experiment retrieved successfully')
      );
    } catch (error) {
      console.error('Error fetching experiment:', error);
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch experiment'));
    }
  })
);
...
router.put(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res.json(
        createResponse(true, experiment, 'Experiment updated successfully')
      );
    } catch (error) {
...
router.delete(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      const experiment = await LabExperiment.findOneAndDelete({
        _id: id,
        userId,
      });
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to delete experiment'));
    }
  })
);
      ...
      res
        ...
        .json(
          createResponse(
            true,
            analysis,
            'Dataset analysis created successfully'
          )
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch dataset analyses'));
    }
  })
);
      ...
      res
        ...
        .json(
          createResponse(
            true,
            imageGen,
            'Image generation request created successfully'
          )
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch image generations'));
    }
  })
);
      ...
      res
        ...
        .json(
          createResponse(
            true,
            analysis,
            'Emotion analysis created successfully'
          )
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch emotion analyses'));
    }
  })
);
      ...
      res
        ...
        .json(
          createResponse(
            true,
            prediction,
            'Future prediction created successfully'
          )
        );
    } catch (error) {
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(
          createResponse(false, null, 'Failed to fetch future predictions')
        );
    }
  })
);
      ...
      res
        ...
        .json(
          createResponse(
            true,
            music,
            'Music generation request created successfully'
          )
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch music generations'));
    }
  })
);
...
router.post(
  ...
  handleAsync(async (req, res) => {
    ...
    if (!validateObjectId(id)) {
      return res
        .status(400)
        .json(createResponse(false, null, 'Invalid music ID'));
    }
    ...
    try {
      ...
      if (!music) {
        return res
          .status(404)
          .json(createResponse(false, null, 'Music generation not found'));
      }
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(201)
        .json(
          createResponse(true, test, 'Personality test created successfully')
        );
    } catch (error) {
...
router.get(
  ...
  handleAsync(async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to fetch personality tests'));
    }
  })
);
...
router.post(
  ...
  handleAsync(async (req, res) => {
    ...
    if (!validateObjectId(id)) {
      return res
        .status(400)
        .json(createResponse(false, null, 'Invalid test ID'));
    }
    ...
    try {
      ...
      if (!test) {
        return res
          .status(404)
          .json(createResponse(false, null, 'Personality test not found'));
      }
        ...
        traits: [
          {
            name: 'Extraversion',
            score: 0.7,
            description: 'High energy and sociability',
          },
        ],
        summary: {
      ...
      res.json(
        createResponse(true, test, 'Test responses submitted successfully')
      );
    } catch (error) {
      console.error('Error submitting test responses:', error);
      res
        .status(500)
        .json(createResponse(false, null, 'Failed to submit responses'));
    }
  })
);
