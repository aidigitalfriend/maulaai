...
function buildAzureSSML(text, voiceName, config, personality) {
...
function mapEmotionToGoogleEffects(config, personality) {
  const baseConfig = {
    audioEncoding: "MP3",
...
function buildPollySSML(text, config, personality) {
