...
const MONGO_URI =
  ...
  'mongodb+srv://onelastai-co:xqUg9PW5iD9g2Dqy@onelastai-co.i5lue.mongodb.net/onelastai?retryWrites=true&w=majority&appName=onelastai-co';
...
async function migrateSubscriptionUsers() {
  ...
  try {
    ...
    const brokenSubs = await subscriptions
      .find({
