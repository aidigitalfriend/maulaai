...
export const chessPlayerConfig: AgentConfig = {
  ...
  personality: {
    ...
    greetingMessage: 'Welcome, fellow strategist! I am Grandmaster Chess. Whether you need help with actual chess moves or strategic thinking in life, I\'m here to help you think several moves ahead. What challenge shall we analyze?',
    specialties: [
