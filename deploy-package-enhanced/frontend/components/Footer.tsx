      ...
      <div className="border-t border-neural-800 w-full bg-gradient-to-r from-neural-900 via-neural-800 to-neural-900">
        <div className="container-custom py-6 px-4 sm:px-6 lg:px-8 w-full max-w-full">
          <div className="text-center mb-4">
            <h3 className="text-lg font-bold text-white mb-1">Download Our Mobile App</h3>
            <p className="text-xs text-neural-400">Available soon on iOS and Android</p>
          </div>
          <div className="flex flex-wrap gap-3 items-center justify-center">
            {/* App Store Badge */}
            <div className="relative group cursor-pointer">
              <div className="bg-neural-800 rounded-lg px-4 py-2 hover:bg-neural-700 transition-all duration-300 border border-neural-700 hover:border-brand-500 flex items-center gap-2">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-neural-400 leading-tight">Download on</p>
                  <h4 className="text-sm font-bold text-white leading-tight">App Store</h4>
                </div>
                <span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-gradient-to-r from-purple-600 to-pink-600 text-white">
                  Soon
                </span>
              </div>
            </div>
            ...
            {/* Play Store Badge */}
            <div className="relative group cursor-pointer">
              <div className="bg-neural-800 rounded-lg px-4 py-2 hover:bg-neural-700 transition-all duration-300 border border-neural-700 hover:border-accent-500 flex items-center gap-2">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-neural-400 leading-tight">Get it on</p>
                  <h4 className="text-sm font-bold text-white leading-tight">Play Store</h4>
                </div>
                <span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-gradient-to-r from-green-600 to-blue-600 text-white">
                  Soon
                </span>
              </div>
            </div>
