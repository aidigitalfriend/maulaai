...
# Auth Pages Simplification Script
# Removes passwordless/magic link authentication
# Keeps only email/password login

echo "🔧 Updating auth pages on server..."

# Update Login Page
cat > ~/shiny-friend-disco/frontend/app/auth/login/page.tsx << 'LOGINEOF'
'use client'
