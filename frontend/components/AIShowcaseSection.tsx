...
const showcaseImages: ShowcaseImage[] = [
  {
    src: '/images/showcase/chat-julie.png',
    fallback: '/images/products/ai-agents.jpeg',
    alt: 'Julie Girlfriend Chat Interface',
    title: 'Personalized AI Companions',
    description: 'Natural conversations with unique AI personalities',
  },
  {
    src: '/images/showcase/chat-sidebar.png',
    fallback: '/images/products/analytics-dashboard.jpeg',
    alt: 'Chat with Conversation History',
    title: 'Smart Conversation Memory',
    description: 'Your chats are saved and easily searchable',
  },
  {
    src: '/images/showcase/canvas-code.png',
    fallback: '/images/products/canvas.jpeg',
    alt: 'AI Canvas Code Generation',
    title: 'AI-Powered Code Generation',
    description: 'Build complete web apps from simple prompts',
  },
  {
    src: '/images/showcase/canvas-preview.png',
    fallback: '/images/products/canvas.jpeg',
