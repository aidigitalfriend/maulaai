      ...
      <div className="relative z-10 container-custom py-16 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
          ...
          <div ref={brandRef} className="lg:max-w-md">
            ...
            <div className="mt-8">
              <p className="text-neural-500 text-xs uppercase tracking-wider mb-3">Mobile Apps</p>
              <div className="flex flex-wrap gap-3">
                {/* App Store Badge */}
                <div className="relative group">
                  <div className="flex items-center gap-2 px-4 py-2.5 bg-neural-800/60 border border-white/10 rounded-xl hover:border-white/20 transition-all duration-300 cursor-not-allowed">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] text-neural-400">Download on the</span>
                ...
                <div className="relative group">
                  <div className="flex items-center gap-2 px-4 py-2.5 bg-neural-800/60 border border-white/10 rounded-xl hover:border-white/20 transition-all duration-300 cursor-not-allowed">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] text-neural-400">GET IT ON</span>
