...
type ActivePanel = 'workspace' | 'assistant' | 'history' | 'files' | 'tools' | 'settings' | null;
    ...
    <div className={`flex flex-col h-screen ${isDarkMode ? 'bg-[#0a0a0a] text-gray-300 matrix-bg' : 'bg-gray-100 text-gray-800'}`}>
      ...
      <div className={`flex-1 flex flex-col relative overflow-hidden ${isDarkMode ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`}>
        ...
        <main className="flex-1 relative flex">
          ...
          >
            <div className="w-80 h-full flex flex-col pb-8">
              ...
              {activePanel === 'history' && (
                <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#111]/95">
                  ...
                  {history.length > 0 ? (
                    <div className="space-y-2">
                      {history.map((app) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 text-xs rounded-lg transition-all truncate border ${
                            currentApp?.id === app.id
                              ? 'bg-cyan-500/20 border-cyan-500/30 text-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.1)]'
                              : 'bg-black/30 text-gray-400 border-gray-800 hover:border-cyan-500/30 hover:bg-cyan-500/10'
                          }`}
                        >
                    ...
                    <div className="text-center py-12 text-gray-600 italic text-xs uppercase tracking-widest">
