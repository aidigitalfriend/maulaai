...
export default function DataGeneratorSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Floating database badge animation
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-20 md:py-32 bg-gradient-to-b from-[#0a0a10] via-[#080a0a] to-[#0a0a10] text-white overflow-hidden relative"
    >
      {/* Background Effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-emerald-600/10 rounded-full filter blur-[150px]"></div>
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-green-500/10 rounded-full filter blur-[150px]"></div>
      </div>
        ...
        {[...Array(12)].map((_, i) => (
          <div
            ...
            style={{
              left: `${8 + (i * 7) % 84}%`,
              top: `${12 + (i * 8) % 76}%`,
              animation: `floatData ${3 + (i % 3)}s ease-in-out infinite`,
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl shadow-2xl border border-white/10 overflow-hidden bg-[#12121a]">
              <Image
            ...
            <div 
              ...
              className="absolute -bottom-4 -right-4 w-20 h-20 bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-500/30"
            >
            ...
            <div 
              ref={statsBadgeRef}
              className="absolute -top-4 -left-4 bg-[#12121a]/90 backdrop-blur-sm rounded-xl p-4 border border-emerald-500/30 hidden lg:block shadow-lg"
            >
              <div className="text-xl font-bold text-emerald-400">50+</div>
              <div className="text-xs text-gray-400">Data Templates</div>
            </div>
          </div>
