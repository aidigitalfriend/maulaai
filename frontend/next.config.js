      ...
      // All HTML pages should revalidate to get correct buildId chunk URLs
      {
        ...
        headers: [
          ...
          // Content Security Policy - allow Stripe, Cloudflare Insights, AI APIs, Google Maps, and S3 uploads
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net https://js.stripe.com https://m.stripe.network https://www.paypal.com https://static.cloudflareinsights.com https://maps.googleapis.com https://maps.gstatic.com https://checkout.stripe.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com https://checkout.stripe.com; img-src 'self' data: blob: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' blob: data: https://onelastai.co https://api.stripe.com https://m.stripe.network https://cloudflareinsights.com https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com https://*.s3.ap-southeast-1.amazonaws.com https://one-last-ai-bucket.s3.ap-southeast-1.amazonaws.com https://maps.googleapis.com https://checkout.stripe.com https://api.ipify.org; frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://www.google.com https://checkout.stripe.com; worker-src 'self' blob: data:; media-src 'self' blob: data: https://www.soundhelix.com https://*.s3.ap-southeast-1.amazonaws.com https://one-last-ai-bucket.s3.ap-southeast-1.amazonaws.com; object-src 'none'; base-uri 'self'; frame-ancestors 'self';",
          },
        ],
      },
    ];
