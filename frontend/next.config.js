  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    ...
    config.optimization = {
      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          heavy: {
            test: /[\\/]node_modules[\\/](stripe|axios|@prisma\/client)[\\/]/,
            name: 'heavy-libs',
    ...
    if (isServer) {
      ...
      config.externals.push({
        // Add any native modules here if needed
      });
    }
      ...
      // All HTML pages should revalidate to get correct buildId chunk URLs
      {
        ...
        headers: [
          ...
          // Content Security Policy - allow Stripe, Cloudflare Insights, AI APIs, Google Maps, and S3 uploads
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net https://js.stripe.com https://m.stripe.network https://www.paypal.com https://static.cloudflareinsights.com https://maps.googleapis.com https://maps.gstatic.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com; img-src 'self' data: blob: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' blob: data: https://maula.ai https://api.stripe.com https://m.stripe.network https://cloudflareinsights.com https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com https://*.s3.ap-southeast-1.amazonaws.com https://maulaai-bucket.s3.ap-southeast-1.amazonaws.com https://maps.googleapis.com; frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://www.google.com; worker-src 'self' blob: data:; media-src 'self' blob: data: https://www.soundhelix.com https://*.s3.ap-southeast-1.amazonaws.com https://maulaai-bucket.s3.ap-southeast-1.amazonaws.com; object-src 'none'; base-uri 'self'; frame-ancestors 'self';",
          },
        ],
      },
    ];
