...
export default function NewsPage() {
  ...
  const newsArticles = [
    ...
    {
      id: 6,
      title: 'Maula AI Community Crosses 50,000 Members',
      ...
      <section className="py-12 bg-white border-b border-neural-200">
        <div className="container-custom text-center max-w-3xl">
          ...
          <p className="text-lg text-neural-600 mb-8">
            Maula AI offers a diverse collection of AI agents designed to help you with virtually anything. From scientific experts to lifestyle coaches, our agents are ready to assist you. Explore our current agents and stay tuned for exciting new additions coming soon!
          </p>
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl font-semibold transition-all flex items-center gap-2 ${
                    selectedCategory === cat.id
                      ...
                      : 'bg-gray-100 text-neural-700 hover:bg-gray-200 border border-neural-200'
                  }`}
                >
                  {cat.label}
                </button>
          ...
          {regularArticles.length > 0 ? (
            <div className="space-y-4">
              {regularArticles.map((article) => (
                <div key={article.id} className="group bg-gradient-to-r from-gray-50 to-white border border-neural-200 hover:border-blue-300 rounded-2xl p-6 transition-all hover:shadow-lg">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white border border-neural-200 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-neural-200 bg-white/95 backdrop-blur">
              ...
              <button aria-label="Close" onClick={() => setShowArticleModal(false)} className="px-3 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 border border-neural-200 text-sm text-neural-700">
                Close
              </button>
            </div>
            ...
            <div className="px-6 py-5 space-y-4 overflow-y-auto max-h-[calc(85vh-64px)]">
              ...
              <div className="pt-4 border-t border-neural-200 flex justify-end">
                <button onClick={() => setShowArticleModal(false)} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-neural-200 rounded-xl text-sm text-neural-700">
                  Close
                </button>
              </div>
            </div>
            ...
            {availableAgents.map((agent) => (
              <div key={agent.id} className="group bg-white rounded-2xl border border-neural-200 shadow-lg hover:shadow-xl hover:border-blue-300 p-6 transition-all">
                ...
                <div className="flex gap-2">
                  ...
                  }} className="bg-gray-100 hover:bg-gray-200 border border-neural-200 px-4 py-2 rounded-xl transition flex items-center justify-center text-neural-700">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {comingSoonAgents.map((agent) => (
              <div key={agent.id} className="group bg-gradient-to-br from-gray-50 to-white border border-neural-200 hover:border-purple-300 rounded-2xl p-6 transition-all hover:shadow-lg opacity-80 hover:opacity-100">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white border border-neural-200 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-neural-200 bg-white/95 backdrop-blur">
              ...
              <button aria-label="Close" onClick={() => setShowAgentDetails(false)} className="px-3 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 border border-neural-200 text-sm text-neural-700">
                Close
              </button>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {selectedAgent.details.map((section: any, idx: number) => (
                      <div key={idx} className="bg-gray-50 border border-neural-200 rounded-xl p-4">
                ...
                {selectedAgent.path ? (
                  <>
                    ...
                    <div className="mt-3 flex gap-3">
                      ...
                      <Link href={selectedAgent.path} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-neural-200 rounded-xl text-sm text-neural-700">Launch Agent</Link>
                    </div>
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link href="/agents" className="px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-neural-200 rounded-xl text-sm text-neural-700">Browse Available Agents</Link>
                    </div>
