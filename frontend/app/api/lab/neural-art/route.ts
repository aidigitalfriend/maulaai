...
const stylePrompts = {
  'van-gogh': 'in the style of Vincent van Gogh, post-impressionism, swirling brushstrokes, vibrant colors',
  'picasso': 'in the style of Pablo Picasso, cubism, geometric shapes, fragmented perspective',
  'monet': 'in the style of Claude Monet, impressionism, soft brushwork, light and color',
  'kandinsky': 'in the style of Wassily Kandinsky, abstract expressionism, bold colors and shapes',
  'dali': 'in the style of Salvador Dalí, surrealism, dreamlike, melting forms',
  'warhol': 'in the style of Andy Warhol, pop art, bold colors, repeated patterns',
  'abstract': 'abstract art style, modern, geometric patterns, vibrant colors',
  'watercolor': 'watercolor painting style, soft edges, translucent colors, flowing'
}
  ...
  try {
    ...
    const output = await replicate.run(
      "stability-ai/sdxl:39ed52f2a78e934b3ba6e2a89f5b1c712de7dfea535525255b1aa35c5565e08b",
      {
        input: {
          image: imageUrl,
          prompt: stylePrompts[style as keyof typeof stylePrompts] || stylePrompts['abstract'],
