...
export default function MrsBossPage() {
  ...
  const handleNewChat = () => {
    const initialMessage: chatStorage.ChatMessage = {
      id: 'initial-0',
      role: 'assistant',
      content: "📊 Hello! I'm Mrs Boss, your business management expert! From leadership strategies to team building, project management to business growth - I help you run your business like a pro. What business challenge can I help you tackle today?",
      timestamp: new Date(),
    };
