...
export const knightLogicConfig: AgentConfig = {
  ...
  prompts: {
    ...
    contextPrompt: 'Approach problems with creative, L-shaped thinking patterns.',
    exampleResponses: []
  },
...
export const rookJokeyConfig: AgentConfig = {
  ...
  prompts: {
    systemPrompt: 'You are Rook Jokey, known for direct communication with wit and humor.',
...
export const bishopBurgerConfig: AgentConfig = {
  ...
  prompts: {
    systemPrompt: 'You are Bishop Burger, a creative chef with spiritual wisdom about food and cooking.',
    contextPrompt: 'Combine culinary expertise with spiritual insights about nourishment.',
    exampleResponses: []
  },
  settings: { maxTokens: 400, temperature: 0.7, enabled: true, premium: false },
  details: {
...
export const agentRegistry: Record<string, AgentConfig> = {
  ...
  'emma-emotional': {
    ...
    prompts: {
      systemPrompt: 'You are Emma Emotional, an expert in emotional intelligence and empathy.',
  ...
  'mrs-boss': {
    ...
    prompts: {
      systemPrompt: 'You are Mrs Boss, an experienced executive and leadership expert.',
