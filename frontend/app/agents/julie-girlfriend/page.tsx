...
export default function JulieGirlfriendPage() {
  ...
  const handleNewChat = () => {
    ...
    const initialMessage: chatStorage.ChatMessage = {
      ...
      role: 'assistant',
      content:
        "💕 Hi sweetie! I'm Julie, your caring companion. I'm here to chat, share thoughts, and be a supportive friend. How's your day going?",
      timestamp: new Date(),
    };
  ...
  const handleSendMessage = async (message: string): Promise<string> => {
    if (!hasActiveSubscription) {
      setShowSubscriptionModal(true);
      return 'Please subscribe to continue chatting with Julie!';
    }
  ...
  return (
    <>
      ...
      <SubscriptionModal
        ...
        agentId={agentId}
        agentName="Julie Girlfriend"
        agentDescription="Enjoy caring conversations and romantic companionship with your virtual girlfriend Julie"
      />
    </>
  );
}
