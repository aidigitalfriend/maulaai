  ...
  const setupSteps = [
    {
      platform: "Slack",
      steps: [
        "Go to Slack App Directory and search for AgentHub",
        "Click 'Add to Slack' and authorize the permissions",
        "Copy your Slack Bot Token from the API settings",
        "Paste the token in AgentHub Settings → Integrations → Slack",
    ...
    },
    {
      ...
      steps: [
        ...
        "Copy the Bot Token",
        "In AgentHub, go to Settings → Integrations → Discord",
