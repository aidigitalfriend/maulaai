        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-gradient-to-br from-neural-900 via-neural-800 to-neural-900 rounded-2xl p-8 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link href="/studio" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-fuchsia-500 rounded-xl font-semibold hover:opacity-90 transition">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-purple-600 to-fuchsia-500 rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/studio" className="btn-primary bg-white text-purple-600 hover:bg-neural-50">
                Open Canvas Builder
              </Link>
