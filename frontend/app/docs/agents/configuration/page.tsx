        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Core Configuration Settings</h2>
            </div>

            <div className="space-y-6">
              {/* Setting 1 */}
              <div className="border-l-4 border-purple-500 pl-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Response Tone</h3>
                <p className="text-gray-600 mb-3">Control how the agent communicates with you:</p>
              ...
              {/* Setting 2 */}
              <div className="border-l-4 border-purple-500 pl-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Response Length</h3>
                <p className="text-gray-600 mb-3">Adjust the detail level of responses:</p>
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-2">
              ...
              {/* Setting 4 */}
              <div className="border-l-4 border-purple-500 pl-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Creativity Level</h3>
                <p className="text-gray-600 mb-3">Control how creative or conservative the agent's responses are:</p>
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-2">
              ...
              <div className="border-l-4 border-purple-500 pl-6">
                ...
                <p className="text-gray-600 mb-3">Manage how the agent uses your conversation history:</p>
                <ul className="list-disc list-inside text-gray-600 space-y-1 ml-2">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Agent-Specific Settings</h2>
          ...
          <section className="bg-green-50 border border-green-200 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Configuration Best Practices</h2>
          ...
          <section className="bg-blue-50 border border-blue-200 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Access Settings</h2>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">New to agents? Start here.</p>
            </Link>
            <Link 
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Learn advanced tips and techniques.</p>
            </Link>
          </section>
        </div>
      </div>
