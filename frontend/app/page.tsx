  ...
  const platformFeatures = [
    {
      ...
      description: 'Access 20+ specialized AI personalities including Einstein, Shakespeare, Tesla, and more. Each agent brings unique expertise to solve your specific challenges.',
      link: {
        text: 'Explore Agents',
        href: '/agents'
      }
    },
    {
      ...
      description: 'Monitor your AI interactions with comprehensive dashboards, usage analytics, and performance insights in real-time.',
      link: {
        text: 'View Dashboard',
        href: '/dashboard'
      }
    },
    {
      ...
      description: 'Bank-level encryption, SOC 2 compliance, and privacy-first architecture ensure your data stays protected and confidential.',
      link: {
    ...
    },
    {
      ...
      description: 'Set up API keys and configure multilingual AI services with our comprehensive environment variable guide.',
      link: {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-neural-600">Get answers to the most common questions about our platform</p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/support/faqs" className="text-brand-600 hover:text-brand-700 font-medium inline-flex items-center gap-2">
              View all FAQs →
            </Link>
          </div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-br from-neural-50 to-neural-100">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-neural-600">Stay informed about new features and platform improvements</p>
          </div>
            ...
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-brand-600">{news.category}</span>
                  <span className="text-sm text-neural-500">{news.date}</span>
                </div>
                <h3 className="text-lg font-bold mb-2">{news.title}</h3>
                <p className="text-neural-600 mb-4">{news.desc}</p>
                <Link href={news.link} className="text-brand-600 hover:text-brand-700 font-medium text-sm inline-flex items-center gap-1">
                  Read more →
                </Link>
              </div>
            ))}
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Integrations & Partnerships</h2>
            <p className="text-xl text-neural-600">Connect with your favorite tools and platforms</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
            {[
              ...
              <div key={idx} className="text-center p-4 rounded-lg bg-neural-50 hover:bg-neural-100 transition-colors">
          ...
          <div className="text-center mt-12">
            <Link href="/about/partnerships" className="text-brand-600 hover:text-brand-700 font-medium inline-flex items-center gap-2">
      ...
      <section className="section-padding bg-gradient-to-br from-neural-900 to-neural-800 text-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-neural-300">Our product roadmap for the next quarters</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quarter: "Q4 2025",
                features: ["Advanced Analytics Dashboard", "Custom Agent Builder", "Team Collaboration Tools"],
                status: "In Progress"
              },
              {
                quarter: "Q1 2026",
                features: ["Multi-language Support", "Real-time Translation", "Enterprise SSO Integration"],
                status: "Planned"
              },
              {
                quarter: "Q2 2026",
                features: ["AI Agent Marketplace", "White-label Solution", "Advanced API Endpoints"],
                status: "Planned"
              }
            ].map((roadmap, idx) => (
              <div key={idx} className="border border-neural-700 rounded-lg p-8 hover:border-brand-600 transition-colors">
                <div className="flex items-center justify-between mb-4">
                ...
                <ul className="space-y-2">
                  {roadmap.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-2 text-neural-300">
          ...
          <div className="text-center mt-12">
            <Link href="/community/roadmap" className="text-white hover:text-brand-300 transition-colors inline-flex items-center gap-2 border border-white px-6 py-3 rounded-lg">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Enterprise Trust & Compliance</h2>
            <p className="text-xl text-neural-600">Meet the highest security and compliance standards</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-center">
            {[
              { badge: "🔒", title: "SOC 2 Type II", desc: "Security compliance verified" },
              { badge: "🌍", title: "GDPR Compliant", desc: "EU data protection" },
              { badge: "🛡️", title: "ISO 27001", desc: "Information security" },
              { badge: "✅", title: "HIPAA Ready", desc: "Healthcare data security" }
            ].map((trust, idx) => (
              <div key={idx} className="text-center p-6 border border-neural-200 rounded-lg hover:border-brand-600 transition-colors">
      ...
      <section className="section-padding bg-gradient-to-r from-brand-600 to-accent-600 text-white">
        <div className="container-custom max-w-2xl">
          <div className="text-center">
            ...
            <p className="text-lg mb-8 text-white/90">Get the latest news, features, and tips delivered to your inbox every week</p>
            ...
            <p className="text-sm text-white/75 mt-4">We respect your privacy. Unsubscribe at any time.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-gradient-to-br from-neural-900 to-neural-800 text-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-neural-300">Choose the plan that works for you</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {[
              ...
              <div key={idx} className={`p-8 rounded-lg transition-transform ${plan.highlighted ? 'bg-gradient-to-br from-brand-600 to-accent-600 scale-105 shadow-lg' : 'bg-neural-800 border border-neural-700'}`}>
                ...
                <p className="text-sm text-neural-200 mb-4">{plan.description}</p>
                <div className="text-4xl font-bold mb-6">{plan.price}<span className="text-lg text-neural-300">{plan.period}</span></div>
                ...
                <Link href="/pricing/overview" className={`block text-center py-3 rounded-lg font-medium transition-colors ${plan.highlighted ? 'bg-white text-brand-600 hover:bg-neutral-100' : 'border border-white text-white hover:bg-neural-700'}`}>
                  Get Started
                </Link>
              </div>
            ))}
          ...
          <div className="text-center">
            <Link href="/pricing/overview" className="text-white hover:text-brand-300 transition-colors inline-flex items-center gap-2">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: "🚀", title: "Lightning Fast", desc: "Deploy AI agents in minutes, not months" },
              { icon: "🔒", title: "Enterprise Security", desc: "Bank-level encryption and compliance" },
              { icon: "📊", title: "Real-time Analytics", desc: "Monitor performance every second" },
              { icon: "🌍", title: "Global Scale", desc: "Serve customers in 100+ countries" },
              { icon: "🤖", title: "AI Expertise", desc: "Built by AI and ML pioneers" },
        ...
        <div className="container-custom text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-neural-300 mb-8 leading-relaxed">
              Join thousands of professionals who trust our AI platform for their most important work.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/contact" className="btn-primary">
                Contact Us
              </Link>
              <Link href="/demo" className="btn-secondary bg-neutral-800 border-neutral-600 text-white hover:bg-neutral-700">
                Schedule Demo
              </Link>
            </div>
          </div>
