    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-2xl p-8 shadow-lg border border-red-200">
          ...
          <h2 className="text-2xl font-bold text-center text-neural-800 mb-2">
      ...
      <div className="flex flex-col items-center">
        <svg width="160" height="100" viewBox="0 0 160 100">
          ...
          <text
            ...
            y="70"
            textAnchor="middle"
            className="fill-neural-800 font-bold text-xl"
          >
            {clamped}%
          </text>
        </svg>
    ...
    return (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        <text
          ...
          textAnchor="middle"
          className="fill-neural-800 font-bold text-lg"
        >
          {clamped.toFixed(1)}%
        </text>
      </svg>
      ...
      <div className="container-custom px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
          <div className="bg-white rounded-2xl p-6 border border-neural-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-neural-600 text-sm mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl p-5 md:p-6 border border-neural-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-base md:text-lg font-semibold mb-2 text-neural-800">
              Platform
            </h3>
                  ...
                  {items.map((it, idx) => (
                    <div key={idx}>
                      <div className="flex items-center justify-between text-sm">
                        <span className="capitalize text-neural-800">
                          {it.name}
                        </span>
          ...
          <div className="bg-white rounded-2xl p-6 border border-neural-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-4">
              {data.incidents.map((incident) => (
                <div
                  key={incident.id}
                  className="bg-neural-700/50 rounded-lg p-4"
                >
