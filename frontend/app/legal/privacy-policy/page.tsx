      ...
      <div className="container-custom section-padding max-w-5xl">
        <div className="space-y-12">
          ...
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-4 text-brand-400">1. Introduction</h2>
            <p className="text-neural-200 leading-relaxed mb-4">
              ...
              specialized AI personalities and services to users worldwide. This Privacy Policy explains how we collect, 
          ...
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">2. Information We Collect</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-white">2.1 Personal Information</h3>
                <p className="text-neural-200 mb-3">Information you provide directly:</p>
                <ul className="list-disc pl-6 text-neural-200 space-y-2">
                  <li><strong className="text-white">Account Information:</strong> Name, email address, username, password</li>
                  <li><strong className="text-white">Profile Information:</strong> Company name, job title, profile picture</li>
                  <li><strong className="text-white">Payment Information:</strong> Billing address, payment method details (processed securely)</li>
                  <li><strong className="text-white">Communication Data:</strong> Support tickets, feedback, chat conversations with AI agents</li>
                  <li><strong className="text-white">Content Data:</strong> Files, documents, prompts submitted to AI agents</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-neural-200 space-y-2">
                  <li><strong className="text-white">Usage Data:</strong> Pages visited, features used, time spent, interaction patterns</li>
                  <li><strong className="text-white">Device Information:</strong> IP address, browser type, operating system, device identifiers</li>
                  <li><strong className="text-white">Location Data:</strong> Approximate geographic location based on IP address</li>
                  <li><strong className="text-white">Cookies & Tracking:</strong> Session cookies, analytics cookies, preference cookies</li>
                  <li><strong className="text-white">Performance Data:</strong> API response times, error logs, system diagnostics</li>
                </ul>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-3 text-white">2.3 AI Interaction Data</h3>
                <p className="text-neural-200 mb-3">When you interact with our AI agents:</p>
                <ul className="list-disc pl-6 text-neural-200 space-y-2">
          ...
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">3. How We Use Your Information</h2>
            <p className="text-neural-200 mb-4">We use collected information for the following purposes:</p>
            
            <div className="space-y-4">
              <div className="bg-neural-900/50 rounded-xl p-6 border border-neural-700/30">
                <h3 className="text-lg font-semibold mb-2 text-brand-300">3.1 Service Delivery</h3>
              ...
              <div className="bg-neural-900/50 rounded-xl p-6 border border-neural-700/30">
                <h3 className="text-lg font-semibold mb-2 text-brand-300">3.2 Platform Improvement</h3>
                <ul className="list-disc pl-6 text-neural-200 space-y-1">
              ...
              <div className="bg-neural-900/50 rounded-xl p-6 border border-neural-700/30">
                <h3 className="text-lg font-semibold mb-2 text-brand-300">3.3 Communication</h3>
                <ul className="list-disc pl-6 text-neural-200 space-y-1">
              ...
              <div className="bg-neural-900/50 rounded-xl p-6 border border-neural-700/30">
                <h3 className="text-lg font-semibold mb-2 text-brand-300">3.4 Security & Compliance</h3>
                <ul className="list-disc pl-6 text-neural-200 space-y-1">
          ...
          {/* Data Sharing */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">4. Data Sharing and Disclosure</h2>
            <p className="text-neural-200 mb-4">We do not sell your personal information. We may share data in the following circumstances:</p>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold mb-2 text-white">4.1 Service Providers</h3>
                <p className="text-neural-200">Third-party vendors who assist with:</p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-white">4.2 Legal Requirements</h3>
                <p className="text-neural-200">When required by law or to:</p>
                <ul className="list-disc pl-6 text-neural-200 space-y-1 mt-2">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-white">4.3 Business Transfers</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-white">4.4 With Your Consent</h3>
                <p className="text-neural-200">
          ...
          {/* Data Retention */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">5. Data Retention</h2>
            <p className="text-neural-200 mb-4">We retain your information for as long as necessary to:</p>
            <ul className="list-disc pl-6 text-neural-200 space-y-2">
            ...
            <div className="mt-4 bg-neural-900/50 rounded-xl p-4 border border-brand-500/20">
              <p className="text-neural-200"><strong className="text-white">Retention Periods:</strong></p>
              <ul className="list-disc pl-6 text-neural-200 space-y-1 mt-2">
                <li>Active accounts: Duration of account + 30 days after deletion</li>
                <li>Conversation history: 90 days (or until manual deletion)</li>
          ...
          {/* Your Rights */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">6. Your Privacy Rights</h2>
            <p className="text-neural-200 mb-4">Depending on your location, you may have the following rights:</p>
            
            <div className="grid gap-4">
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Access</h3>
                <p className="text-neural-200 text-sm">Request a copy of your personal data</p>
              </div>
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Rectification</h3>
                <p className="text-neural-200 text-sm">Correct inaccurate or incomplete data</p>
              </div>
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Erasure</h3>
                <p className="text-neural-200 text-sm">Request deletion of your personal data</p>
              </div>
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Data Portability</h3>
                <p className="text-neural-200 text-sm">Receive your data in a structured, machine-readable format</p>
              </div>
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Object</h3>
                <p className="text-neural-200 text-sm">Object to processing of your personal data</p>
              </div>
              <div className="bg-neural-900/50 rounded-xl p-4 border border-neural-700/30">
                <h3 className="font-semibold text-brand-300 mb-2">✓ Right to Withdraw Consent</h3>
                <p className="text-neural-200 text-sm">Withdraw consent for data processing at any time</p>
              </div>
            </div>

            <div className="mt-6 bg-brand-900/20 rounded-xl p-6 border border-brand-500/30">
              <p className="text-white font-semibold mb-2">How to Exercise Your Rights:</p>
              <p className="text-neural-200">
                Email us at{' '}
                <a href="mailto:privacy@onelastai.co" className="text-brand-400 hover:text-brand-300 underline">
          ...
          {/* Security */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">7. Data Security</h2>
            <p className="text-neural-200 mb-4">
              We implement industry-standard security measures to protect your information:
            </p>
            <ul className="list-disc pl-6 text-neural-200 space-y-2">
              <li><strong className="text-white">Encryption:</strong> TLS/SSL encryption for data in transit, AES-256 encryption for data at rest</li>
              ...
              <li><strong className="text-white">Regular Audits:</strong> Third-party security assessments and penetration testing</li>
              <li><strong className="text-white">Data Backup:</strong> Regular encrypted backups with disaster recovery</li>
              <li><strong className="text-white">Employee Training:</strong> Security awareness and data protection training</li>
            </ul>
            <p className="text-neural-300 mt-4 text-sm">
          ...
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">8. International Data Transfers</h2>
            <p className="text-neural-200 mb-4">
              As a global platform, we may transfer your data to countries outside your residence. We ensure appropriate 
          ...
          {/* Children's Privacy */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">9. Children's Privacy</h2>
            <div className="bg-red-900/20 rounded-xl p-6 border border-red-500/30">
              <p className="text-neural-200 mb-3">
                <strong className="text-white">Age Restriction:</strong> Our services are NOT intended for individuals 
          ...
          {/* Cookies */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">10. Cookies and Tracking</h2>
            <p className="text-neural-200 mb-4">
              We use cookies and similar tracking technologies. For detailed information, please see our{' '}
              <a href="/legal/cookie-policy" className="text-brand-400 hover:text-brand-300 underline font-medium">
                Cookie Policy
              </a>.
            </p>
          </section>
          ...
          {/* Changes to Policy */}
          <section className="bg-neural-800/50 rounded-2xl p-8 border border-neural-700/50">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">11. Changes to This Policy</h2>
            <p className="text-neural-200">
              We may update this Privacy Policy periodically. We will notify you of significant changes via email or 
              a prominent notice on our platform. Continued use of our services after changes constitutes acceptance 
          ...
          <section className="bg-gradient-to-r from-brand-900/30 to-accent-900/30 rounded-2xl p-8 border border-brand-500/30">
            <h2 className="text-3xl font-bold mb-6 text-brand-400">12. Contact Us</h2>
            <div className="space-y-3 text-neural-200">
              ...
              <p>Email: <a href="mailto:privacy@onelastai.co" className="text-brand-400 hover:text-brand-300 underline">privacy@onelastai.co</a></p>
              ...
              <div className="mt-6 pt-6 border-t border-neural-700/50">
                <p className="text-sm text-neural-300">
                  <strong className="text-white">EU Representative:</strong> For users in the European Union, 
                  you may contact our EU representative regarding data protection matters.
                </p>
              </div>
            </div>
          </section>
